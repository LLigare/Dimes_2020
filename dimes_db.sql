...
--
-- Host: 127.0.0.1
-- Generation Time: May 31, 2020 at 06:49 PM
...
CREATE TABLE `loan_application` (
  `loan_id` int(5) NOT NULL,
  `loan_eligibility` varchar(15) NOT NULL,
...
INSERT INTO `members` (`mem_id`, `fname`, `lname`, `uname`, `password`, `dob`, `join_date`, `phone`, `gender`, `region`, `cont_id`, `role_id`, `min_id`, `news_id`) VALUES
(1, 'K', 'K', 'KK', 'we', '2020-04-28', '2020-05-27', '097', 'm', 'Voi', 0, 0, 0, 0);
...
ALTER TABLE `loan_application`
  ...
  ADD KEY `cont_id` (`cont_id`,`grnt_id`),
...
--
ALTER TABLE `members`
  MODIFY `mem_id` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
ALTER TABLE `loan_repayment`
  ADD CONSTRAINT `loan_repayment_ibfk_1` FOREIGN KEY (`rep_id`) REFERENCES `loan_application` (`loan_id`);
COMMIT;
